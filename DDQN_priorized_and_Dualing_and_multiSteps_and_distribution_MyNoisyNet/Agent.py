...
class Agent(object):
    ...
    def remove_noise_main_net(self):
        self.model.remove_noise_main_net()
        
    def remove_noise_target_net(self):
        self.model.remove_noise_target_net()
        
        
    def reset_main_net_noise(self):
        self.model.reset_main_net_noise()
        
    def reset_target_net_noise(self):
        self.model.reset_target_net_noise()
    ...
    def sample_action(self, x,training):
        action = self.model.sample_action(x, training = training)
        self.action = action
        return action
    
    def sample_action_e_based(self, x, eps, training):
